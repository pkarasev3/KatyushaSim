function [ rocket ] = drawRocket01( rocket )
  ...
  dbstop if error
   ...
   if( strcmp(ptype,'perspective' ) )
     ...
     % step 5. make a plume   
     %     better way to do it:  store the previous position of rocket,
     %     make the plume around these locations! 
    ...
    function plot3d_debug_plume( )
      sfigure(4); title('plume-3d rocket01');
